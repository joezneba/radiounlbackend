...
<div>    
    ...
    echo form_open_multipart('banner/guardarBanner/', 'id="formulario" name="formulario"class="form-horizontal"');
    ?>
    <div class="wrapper">
        <div class="form-group col-lg-12">
            <label for="Estatus" class="col-lg-2 control-label">BANNER  :</label>
            <div class="col-lg-4">
